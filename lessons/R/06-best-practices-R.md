...
<pre class='in'><code>#This is code to replicate the analyses and figures from my 2014 Science paper.
...
<pre class='in'><code>source("my_genius_fxns.R")</code></pre>
...
<pre class='in'><code>dat <- read.csv(file = "/files/dataset-2013-01.csv", header = TRUE)</code></pre>

rather than:


<pre class='in'><code>dat <- read.csv(file = "/Users/Karthik/Documents/sannic-project/files/dataset-2013-01.csv", header = TRUE)</code></pre>
